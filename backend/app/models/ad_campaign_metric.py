...
class AdCampaignMetric(Base):
    ...
    __table_args__ = (
        ...
        UniqueConstraint(
            "store_id",
            "source_row_hash",
            name="uq_ad_campaign_metrics_store_source_row_hash",
        ),
    )
    ...
    daily_spend: Mapped[Decimal] = mapped_column(Numeric(12, 2), default=Decimal("0"), nullable=False)
    clicks: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    orders: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    acos: Mapped[Decimal] = mapped_column(Numeric(12, 2), default=Decimal("0"), nullable=False)
    roas: Mapped[Decimal] = mapped_column(Numeric(12, 2), default=Decimal("0"), nullable=False)
    conversion_rate: Mapped[Decimal] = mapped_column(
        Numeric(12, 2), default=Decimal("0"), nullable=False
    )
    created_at: Mapped[DateTime] = mapped_column(DateTime(timezone=True), default=utcnow, nullable=False)

    store = relationship("Store", back_populates="ad_campaign_metrics")
